    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StepsIngredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StepsIngredients_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StepsIngredients_Steps_StepId",
                        column: x => x.StepId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StepsIngredients_IngredientId",
                table: "StepsIngredients",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_StepsIngredients_StepId",
                table: "StepsIngredients",
                column: "StepId");
        }
